...
const ZONES = [
  ...
  {id:'outpost',name:'Ruined Outpost',num:'II',reqLvl:3,kills:10,
   ...
   enemies:[
     {id:'skeleton',name:'Skeleton Warrior',sprite:'skeleton',color:'#8a8a7a',hp:26,atk:9,def:2,xp:15,gold:5,saveType:'str',saveDC:12,isUndead:true},
     {id:'zombie',name:'Rotting Zombie',sprite:'zombie',color:'#5a7a4a',hp:34,atk:11,def:3,xp:18,gold:5,saveType:'con',saveDC:12,isUndead:true},
     {id:'ghost',name:'Wailing Ghost',sprite:'ghost',color:'#7a8aaa',hp:20,atk:11,def:0,xp:20,gold:6,saveType:'wis',saveDC:13,isUndead:true,ignoresArmor:true},
     {id:'wolf',name:'Cursed Archer',sprite:'wolf',color:'#6a5a3a',hp:22,atk:12,def:1,xp:17,gold:5,saveType:'dex',saveDC:12,isUndead:true,dropMat:'bone'},
     {id:'goblin',name:'Death Knight',sprite:'goblin',color:'#3a2a4a',hp:40,atk:9,def:5,xp:19,gold:6,saveType:'str',saveDC:13,isUndead:true,dropMat:'bone'},
   ],
   boss:{id:'grakthar',name:'Commander Grakthar',title:'The Undying Warlord',sprite:'grakthar',color:'#8a3a2a',
     hp:120,atk:13,def:5,xp:130,gold:65,saveType:'str',saveDC:14,isBoss:true,isUndead:true,
  ...
  {id:'castle',name:'Thornwall Castle',num:'III',reqLvl:6,kills:12,
   ...
   enemies:[
     {id:'goblin',name:'Crimson Cultist',sprite:'goblin',color:'#8b1a1a',hp:38,atk:12,def:4,xp:22,gold:7,saveType:'int',saveDC:14,canBurn:true},
     {id:'zombie',name:'Castle Guard',sprite:'zombie',color:'#5a5a8a',hp:52,atk:17,def:7,xp:26,gold:8,saveType:'str',saveDC:14},
     {id:'spider',name:'Gargoyle',sprite:'spider',color:'#6a6a8a',hp:44,atk:16,def:8,xp:24,gold:8,saveType:'dex',saveDC:13},
     {id:'ghost',name:'Dark Sorcerer',sprite:'ghost',color:'#6a1a6a',hp:30,atk:16,def:2,xp:25,gold:8,saveType:'int',saveDC:14,canBurn:true,ignoresArmor:true,dropMat:'voidShard'},
     {id:'skeleton',name:'Iron Sentinel',sprite:'skeleton',color:'#4a4a6a',hp:60,atk:13,def:10,xp:24,gold:8,saveType:'con',saveDC:14,canStun:true,dropMat:'ironCore'},
   ],
   boss:{id:'vexara',name:'Vexara the Crimson',title:'High Priestess of Ruin',sprite:'vexara',color:'#8b0000',
     hp:270,atk:20,def:10,xp:190,gold:90,saveType:'wis',saveDC:16,isBoss:true,
  ...
  {id:'underdark',name:'The Underdark',num:'IV',reqLvl:9,kills:14,
   ...
   enemies:[
     {id:'spider',name:'Phase Spider',sprite:'spider',color:'#4a2a8a',hp:58,atk:18,def:6,xp:32,gold:10,saveType:'dex',saveDC:15,canPoison:true},
     {id:'ghost',name:'Shadow Wraith',sprite:'ghost',color:'#2a2a4a',hp:50,atk:24,def:2,xp:36,gold:12,saveType:'wis',saveDC:15,isUndead:true,ignoresArmor:true},
     {id:'zombie',name:'Stone Golem',sprite:'zombie',color:'#6a6a5a',hp:80,atk:22,def:14,xp:34,gold:11,saveType:'con',saveDC:15,canStun:true},
     {id:'goblin',name:'Mind Flayer',sprite:'goblin',color:'#5a2a7a',hp:45,atk:24,def:4,xp:37,gold:13,saveType:'int',saveDC:16,canStun:true,dropMat:'voidShard'},
     {id:'wolf',name:'Deep Lurker',sprite:'wolf',color:'#2a3a5a',hp:70,atk:20,def:8,xp:34,gold:11,saveType:'dex',saveDC:15,canPoison:true,dropMat:'ghostEssence'},
   ],
   boss:{id:'nethrix',name:'Nethrix',title:'Devourer of Worlds',sprite:'nethrix',color:'#4a0a8a',
     hp:380,atk:26,def:14,xp:280,gold:130,saveType:'con',saveDC:17,isBoss:true,
  ...
  {id:'abyss',name:'Abyssal Gate',num:'V',reqLvl:12,kills:15,
   ...
   enemies:[
     ...
     {id:'wolf',name:'Hellhound',sprite:'wolf',color:'#8a2a0a',hp:85,atk:29,def:10,xp:48,gold:16,saveType:'str',saveDC:16,canBurn:true},
     {id:'skeleton',name:'Bone Colossus',sprite:'skeleton',color:'#aaaaaa',hp:110,atk:31,def:16,xp:52,gold:18,saveType:'str',saveDC:17,isUndead:true,canStun:true},
     {id:'ghost',name:'Chaos Imp',sprite:'ghost',color:'#8a1a5a',hp:55,atk:28,def:4,xp:46,gold:16,saveType:'dex',saveDC:16,canBurn:true,ignoresArmor:true,dropMat:'demonAsh'},
     {id:'zombie',name:'Infernal Juggernaut',sprite:'zombie',color:'#5a1a0a',hp:130,atk:24,def:18,xp:54,gold:19,saveType:'con',saveDC:17,canBurn:true,canStun:true,dropMat:'demonAsh'},
   ],
   boss:{id:'zareth',name:'Zareth the Sundered',title:'Lord of the Abyss',sprite:'zareth',color:'#4a0000',
     hp:520,atk:32,def:18,xp:400,gold:200,saveType:'str',saveDC:18,isBoss:true,
  ...
  {id:'frostpeak',name:'Frostveil Peaks',num:'VI',reqLvl:15,kills:16,
   ...
   enemies:[
     {id:'zombie',name:'Frost Troll',sprite:'zombie',color:'#6a8aaa',hp:120,atk:30,def:12,xp:58,gold:21,saveType:'str',saveDC:17,canStun:true},
     {id:'wolf',name:'Winter Wyvern',sprite:'wolf',color:'#8aaacc',hp:100,atk:37,def:10,xp:62,gold:22,saveType:'dex',saveDC:18,canPoison:true},
     {id:'ghost',name:'Blizzard Wraith',sprite:'ghost',color:'#aaccee',hp:85,atk:39,def:4,xp:60,gold:22,saveType:'wis',saveDC:18,isUndead:true,ignoresArmor:true},
     {id:'skeleton',name:'Glacial Golem',sprite:'skeleton',color:'#aabbcc',hp:145,atk:28,def:20,xp:64,gold:23,saveType:'con',saveDC:18,canStun:true},
     {id:'goblin',name:'Frost Witch',sprite:'goblin',color:'#ccddff',hp:90,atk:38,def:6,xp:63,gold:22,saveType:'int',saveDC:18,canPoison:true,canStun:true,dropMat:'frostCrystal'},
   ],
   boss:{id:'valdris',name:'Valdris the Unbroken',title:'Titan of the Frozen Age',sprite:'zareth',color:'#6aaacc',
     hp:660,atk:38,def:22,xp:520,gold:260,saveType:'str',saveDC:19,isBoss:true,
  ...
  {id:'celestial',name:'Celestial Plane',num:'VII',reqLvl:18,kills:18,
   ...
   enemies:[
     {id:'ghost',name:'Fallen Seraphim',sprite:'ghost',color:'#ccaaff',hp:130,atk:44,def:8,xp:72,gold:27,saveType:'wis',saveDC:19,ignoresArmor:true},
     {id:'goblin',name:'Astral Assassin',sprite:'goblin',color:'#9966ff',hp:115,atk:48,def:12,xp:70,gold:26,saveType:'dex',saveDC:19},
     {id:'spider',name:'Void Tendril',sprite:'spider',color:'#5533aa',hp:140,atk:38,def:15,xp:74,gold:28,saveType:'con',saveDC:20,canPoison:true},
     {id:'wolf',name:'Divine Hound',sprite:'wolf',color:'#eeccaa',hp:155,atk:36,def:18,xp:76,gold:29,saveType:'str',saveDC:20,canBurn:true},
   ],
   boss:{id:'auranthos',name:'Auranthos',title:'The Blind God',sprite:'nethrix',color:'#ccaaff',
     hp:810,atk:50,def:26,xp:650,gold:320,saveType:'wis',saveDC:20,isBoss:true,
  ...
  {id:'shadowrealm',name:'The Shadow Realm',num:'VIII',reqLvl:20,kills:20,
   ...
   enemies:[
     {id:'ghost',name:'Shade Revenant',sprite:'ghost',color:'#443366',hp:160,atk:54,def:10,xp:85,gold:33,saveType:'wis',saveDC:20,isUndead:true,ignoresArmor:true},
     {id:'spider',name:'Nightmare Stalker',sprite:'spider',color:'#221133',hp:175,atk:56,def:16,xp:88,gold:34,saveType:'dex',saveDC:21,canPoison:true},
     {id:'zombie',name:'Abyssal Hulk',sprite:'zombie',color:'#332244',hp:210,atk:44,def:24,xp:90,gold:35,saveType:'con',saveDC:21,canStun:true},
     {id:'skeleton',name:'Void Knight',sprite:'skeleton',color:'#554477',hp:190,atk:58,def:20,xp:92,gold:36,saveType:'str',saveDC:21,isUndead:true},
   ],
   boss:{id:'malvaris',name:'Malvaris',title:'The Hollow Empress',sprite:'nethrix',color:'#220033',
     hp:1000,atk:64,def:30,xp:800,gold:400,saveType:'wis',saveDC:22,isBoss:true,
...
const ITEMS = [
  ...
  // ── CONSUMABLES ──────────────────────────────────────────
  {id:'hpPotion',name:'Healing Potion',icon:'🧪',type:'consumable',slot:null,rarity:'common',stats:{heal:15},value:15},
  {id:'strongPotion',name:'Strong Potion',icon:'⚗️',type:'consumable',slot:null,rarity:'uncommon',stats:{heal:35},value:40},
  {id:'elixir',name:'Elixir of Life',icon:'✨',type:'consumable',slot:null,rarity:'rare',stats:{heal:60},value:100},
...
const UPGRADES_DATA = [
  {id:'blade',name:'Sharpen Blade',icon:'⚔️',desc:'+5 ATK',cost:80,eff:'atk',val:5},
  {id:'tough',name:'Toughen Up',icon:'❤️',desc:'+30 Max HP',cost:110,eff:'maxHp',val:30},
  {id:'iron',name:'Reinforce Armor',icon:'🛡️',desc:'+8 DEF',cost:170,eff:'def',val:8},
  {id:'xpbook',name:"Scholar's Tome",icon:'📚',desc:'+20% XP',cost:250,eff:'xpMult',val:.2},
  {id:'crit',name:'Eagle Eye',icon:'🎯',desc:'+1 Crit range',cost:230,eff:'crit',val:1},
];
...
const RANDOM_EVENTS = [
  ...
  {title:'THE MYSTERIOUS MERCHANT',
   ...
   choices:[
     {text:'Buy it for 50g — temporary power surge',outcome:(g)=>{if(g.gold>=50){g.gold-=50;g.atk+=8;g.critBonus=(g.critBonus||0)+3;return '✓ Lightning courses through you. ATK +8, Crit +3 for this zone!'}return '✗ Not enough gold.'}},
  ...
  {title:'THE MIRROR OF REGRET',
   ...
   choices:[
     {text:'Reach into the mirror (trade HP for power)',outcome:(g)=>{const cost=Math.floor(g.maxHp*.15);g.maxHp-=cost;g.hp=Math.min(g.hp,g.maxHp);g.atk+=12;g.critBonus=(g.critBonus||0)+5;return '✓ Your reflection steps out and merges with you. Max HP -'+cost+', but ATK +12, Crit +5.'}},
  ...
  {title:'THE FROST GIANT\'S CHALLENGE',
   ...
   choices:[
     ...
     {text:'Tell it a joke (random outcome)',outcome:(g)=>{const r=Math.random();if(r<.33){g.atk+=8;g.def+=5;return '✓ The giant howls with laughter. "Go, little funny-thing!" It tosses you a charm. ATK +8, DEF +5.'}if(r<.66)return '... it stares at you blankly, then steps aside without a word.';g.hp=Math.max(1,g.hp-20);return '✗ It doesn\'t get it. You get a flick to the chest for 20 HP.'}},
   ]},
  ...
  {title:'THE MUSHROOM CIRCLE',
   ...
   choices:[
     {text:'Eat one mushroom (50/50)',outcome:(g)=>{if(Math.random()<.5){g.atk+=5;g.maxHp+=10;g.hp+=10;return '✓ Visions of battle sharpen your mind. ATK +5, Max HP +10.'}g.hp=Math.max(1,g.hp-8);return '✗ The world tilts. Lost 8 HP.'}},
